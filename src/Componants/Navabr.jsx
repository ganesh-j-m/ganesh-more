            ...
            <div className='container mx-auto flex justify-between items-center'>
                ...
                <div>
                    <a href="#" className='text-3xl font-bold text-white'>
                        Coder
                        <span className='text-purple'>Ganesh</span>
                ...
                <div className='hidden md:flex space-x-10'>
                    ...
                    <a href="#achivements" className='relative text-white/80 transition duration-300 hover:text-purple group'>
...

            {
                showMenu && (
                    <div className='md:hidden mt-4 bg-dark-300 h-screen rounded-lg p-4 flex flex-col space-y-4 text-center justify-center'>
                        ...
                        <a onClick={() => setShowMenu(!showMenu)} href="#achivement" className='relative text-white/80 transition duration-300 hover:text-purple group'>
